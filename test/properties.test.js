...
describe('properties API', () =>
{
    ...
    afterAll(async () =>
    {
        ...
        {
            await request(app).delete(`/api/v1/properties/${uuid}`).set('Authorization', `Bearer ${token}`);
        }
    });
    ...
    it('creates a property with a valid body', async () =>
    {
        ...
        expect(res.body.data).toMatchObject({ title: 'Test Villa', description: 'A nice place', price: 250000 });
